...
1. 【开场 15s】这把键盘一排 AI 键，不装官方软件全是摆设——今天把它彻底破解
2. 【痛点 30s】官方软件：只有 Win、常驻后台、功能死板、麦克风被独占
3. 【演示 90s】装开源工具 → AI 键一键唤起 AI 助手 → 键盘麦接进微信语音输入 → 打字统计
4. 【技术 60s】Electron 明文源码逆向 + HID 抓包标定 + mi-sbc 音频解码（快剪）
5. 【收尾 15s】开源地址 + 「正在收集 200 份反馈，评论区说说你想要什么功能」
